...
export const scribbes = createSlice({
  ...
  reducers: {
    ...
    handleCoponentState(state, action) {
      state.componentState= action.payload;
    },
  },
});
// Action creators are generated for each case reducer function
export const { handleCoponentState,chnagePageView,handleScrribsTabs,chnageSpecficInterst,handleSettingTabs, handleMessageView, chnageAdminToolTabs } =
  scribbes.actions;
