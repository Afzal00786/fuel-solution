      ...
      <div className="relative  w-full min-h-[100vh] bg-[#F8F8F8] px-[15px] sm:px-[0px]">
        <div className="pb-[30px] sm:pb-[50px]">
          <div className="flex justify-center flex-col items-center ">
            <div className="pt-[10px] sm:pt-[20px] text-[#1CAC19] text-[32px]  sm:text-[42px] font-bold font-sans  leading-[52px]  sm:leading-[62px] tracking-[-0.085em]">
            <Link href="/">Fuel Solution</Link>
            </div>
            <div className="w-full sm:w-[564px] mt-[0px]  sm:mt-[10px]  shadow-signup pt-[20px] sm:pt-[20px] pb-[37px] px-[20px] sm:px-[45px] rounded-[37px] bg-white z-10">
              <div className="flex justify-center text-[28px] sm:text-heading font-bold text-black font-grotesk">
                Create a new account
              </div>
              <div className="mt-[10px] sm:mt-[10px]  flex justify-evenly items-center">
              ...
              <div className="flex justify-between items-center mt-[20px] xl:mt-[20px] 2xl:mt-[20px]">
